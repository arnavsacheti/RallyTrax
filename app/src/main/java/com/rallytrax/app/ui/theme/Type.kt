...
// ── Rugged Mode: Scaled-up typography for limited-mobility environments ──────

val RuggedTypography = Typography(
    ...
    displaySmall = TextStyle(fontSize = 40.sp, fontWeight = FontWeight.Normal, lineHeight = 48.sp, letterSpacing = 0.sp),
    headlineLarge = TextStyle(fontSize = 36.sp, fontWeight = FontWeight.Normal, lineHeight = 44.sp, letterSpacing = 0.sp),
    headlineMedium = TextStyle(fontSize = 32.sp, fontWeight = FontWeight.Normal, lineHeight = 40.sp, letterSpacing = 0.sp),
    headlineSmall = TextStyle(fontSize = 28.sp, fontWeight = FontWeight.Normal, lineHeight = 36.sp, letterSpacing = 0.sp),
    titleLarge = TextStyle(fontSize = 26.sp, fontWeight = FontWeight.Normal, lineHeight = 32.sp, letterSpacing = 0.sp),
    titleMedium = TextStyle(fontSize = 20.sp, fontWeight = FontWeight.Medium, lineHeight = 28.sp, letterSpacing = 0.15.sp),
    titleSmall = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Medium, lineHeight = 24.sp, letterSpacing = 0.1.sp),
    bodyLarge = TextStyle(fontSize = 20.sp, fontWeight = FontWeight.Normal, lineHeight = 28.sp, letterSpacing = 0.5.sp),
    bodyMedium = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Normal, lineHeight = 24.sp, letterSpacing = 0.25.sp),
    bodySmall = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Normal, lineHeight = 20.sp, letterSpacing = 0.4.sp),
    labelLarge = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Medium, lineHeight = 24.sp, letterSpacing = 0.1.sp),
    labelMedium = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Medium, lineHeight = 20.sp, letterSpacing = 0.5.sp),
    labelSmall = TextStyle(fontSize = 14.sp, fontWeight = FontWeight.Medium, lineHeight = 20.sp, letterSpacing = 0.5.sp),
)
